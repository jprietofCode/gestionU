    ...
    public function IniciarSesionC(){
        ...
        if(isset($_POST["libreta"])){
            ...
            if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["libreta"]) && preg_match('/^[a-zA-Z0-9.]+$/', $_POST["clave"])){
                ...
                if ($resultado && $resultado["libreta"] == $_POST["libreta"] && $resultado["clave"] == $_POST["clave"]){
                ...
                //var_dump($resultado);
                /*if(!isset($resultado["libreta"]) || !isset($resultado["clave"])){
                    echo '<br> <div class="alert alert-danger">Error al Ingresar</div>';

                }elseif ($resultado["libreta"] == $_POST["libreta"] && $resultado["clave"] == $_POST["clave"]){
                    $_SESSION["Ingresar"] = true;
        ...
        if(isset($_POST["Uid"])){
            ...
            if($resultado){
                ...
                echo '<script>
					...
					window.location = "http://localhost/learnphp/gestionU/mis-datos";
					</script>';
