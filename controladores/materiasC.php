        ...
        if(isset($_POST["Cid"])){
            ...
            if($resultado == true){
                ...
                echo '<script>
					...
					window.location = "http://localhost/learnphp/gestionU/Crear-Materias/'.$Cid.'";
					</script>';
        ...
        if(isset($_POST["id_materia"])){
            ...
            if($resultado == true){
                ...
                echo '<script>
					...
					window.location = "http://localhost/learnphp/gestionU/Crear-Comisiones/'.$id_materia.'";
					</script>';
        ...
        if(isset($_GET["Mid"])){
            ...
            if($resultado == true){
                ...
                echo '<script>
					...
					window.location = "http://localhost/learnphp/gestionU/Crear-Comisiones/'.$Mid.'";
					</script>';
        ...
        if(isset($_POST["id_alumno"])){
            ...
            if($resultado == true){
                ...
                echo '<script>
					...
					window.location = "http://localhost/learnphp/gestionU/Ver-Plan/'.$id_carrera.'/'.$libreta.'";
					</script>';
